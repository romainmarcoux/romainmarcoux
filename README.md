...
- [malicious-ip](https://github.com/romainmarcoux/malicious-ip) : agrégation d'adresses IP malveillantes (scanners, bruteforce ...) à bloquer en **entrée** (WAN > LAN)
...
- [malicious-domains](https://github.com/romainmarcoux/malicious-domains) : agrégation de domaines malveillants (phishing / hameçonnage, malware ...) à bloquer en **sortie** (LAN > WAN)
